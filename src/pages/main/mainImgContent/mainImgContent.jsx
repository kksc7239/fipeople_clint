        ...
        return (
            <div className={style.mainImgContent} id="mainImgContent" style={{height:this.state.ih+'px'}}>
                <div className={style.content}>
                    <div className={style.subMessage}><Typist><Typist.Delay ms={3000} />MBTI를 기반으로 “새 친구"를 만나보세요!</Typist></div>
                    <div className={style.mainMessage}><Typist><Typist.Delay ms={700} />나와 “잘 맞는” 새 친구를<br/>만나보고 싶으신가요?</Typist></div>
